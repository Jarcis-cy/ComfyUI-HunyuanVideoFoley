    ...
    def kl(self, other=None):
        if self.deterministic: return torch.Tensor([0.0])
            ...
            if other is None:
                ...
                return 0.5 * torch.mean(torch.pow(self.mean - other.mean, 2) / other.var + self.var / other.var - 1.0 - self.logvar + other.logvar, dim=[1, 2],)
...
def normal_kl(mean1, logvar1, mean2, logvar2):
    ...
    for obj in (mean1, logvar1, mean2, logvar2):
        if isinstance(obj, torch.Tensor): tensor = obj; break
